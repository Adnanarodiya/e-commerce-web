...
export const translations = {
  en: {
    ...
    discountBanner:
      "🎉 Special Offer: Buy for ₹5,000 or more — Bank/UPI 10% off books, Cash 15% off books, plus ₹25 off each Quran copy!",
    ...
    noPackagingCharge: "No packaging charge",
    noCourierCharge: "No courier charge",
    quotationChargesRequired:
      "Enter packaging & courier amounts, or tick “No charge” for each if not applicable.",
  ...
  ur: {
    ...
    discountBanner:
      "🎉 خصوصی پیشکش: ₹5,000 یا اس سے زیادہ — بینک/UPI پر کتابوں پر %10، کیش پر %15، اور ہر قرآن کی نقل پر ₹25 رعایت!",
    ...
    noPackagingCharge: "کوئی پیکجنگ چارج نہیں",
    noCourierCharge: "کوئی کورئیر چارج نہیں",
    quotationChargesRequired:
      "پیکجنگ اور کورئیر کی رقم درج کریں، یا اگر لاگو نہ ہو تو ہر ایک کے لیے «کوئی چارج نہیں» منتخب کریں۔",
